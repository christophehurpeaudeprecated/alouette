...
var HtmlRenderer = (function () {
  var HtmlRenderer = function HtmlRenderer(options) {
    this.options = options || {};
  };

  HtmlRenderer.prototype.openLocalFile = function (filePath, lineNumber, columnNumber, realFilePath) {
  ...
  HtmlRenderer.prototype.replaceAppInFilePath = function (filePath) {
  ...
  HtmlRenderer.prototype.render = function (error) {
  ...
  HtmlRenderer.prototype.renderStack = function (error) {
    var _this = this;
  ...
  HtmlRenderer.prototype.highlightLine = function (contents, lineNumber, columnNumber) {
  ...
  HtmlRenderer.prototype.lines = function (withLineNumbers, startNumber, _lines) {
    var _this2 = this;
    var content = "";
  ...
  HtmlRenderer.prototype.line = function (withLineNumbers, lineNumber, attributes, contentLine) {
  ...
  HtmlRenderer.prototype.tag = function (tagName, attributes, content, contentEscape) {
