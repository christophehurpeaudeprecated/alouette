...
var escape = /** @function 
             * @param text */function escape(text) {
    ...
    _createClass(HtmlRenderer, [{
        ...
        * @param error */value: function renderStack(error) {
            ...
            stackTrace.forEach(function (item, i) {
                ...
                } else if (_this.item.typeName) {
                    str += _this.typeName + '.' + (_this.methodName || '<anonymous>');
                }
        ...
        * @param contents 
        * @param lineNumber 
        * @param columnNumber */value: function highlightLine(contents, lineNumber, columnNumber) {
