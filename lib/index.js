...
var ParsedError = function() {
  ...
  $__Object$defineProperties(ParsedError.prototype, {toString: {
      value: function() {
...
var StackTrace = function() {
  ...
  $__Object$defineProperties(StackTrace.prototype, {
    forEach: {
      value: function() {
        var $__arguments0 = arguments;
        var $__arguments = $__arguments0;
        return this.items.forEach.apply(this.items, $__arguments);
      },
      enumerable: false,
      writable: true
    },
...
var StackTraceItem = function() {
  ...
  $__Object$defineProperties(StackTraceItem.prototype, {
    getFileName: {
      value: function() {
